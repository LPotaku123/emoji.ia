...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/UbPjwJSZ_/model.json',modelLoaded);
...
{
    document.getElementById("uptadeEmohi").innerHTML = "&#128522;";
}
